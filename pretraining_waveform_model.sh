...
--log_dir "/home/apoman123/data/nas07/PersonalData/apoman123/pretrain_wavemae_checkpoints/logs"  --model_path "/data/nas07/PersonalData/apoman123/pretrain_wavemae_checkpoints/WaveMAE_epoch_18.pth"